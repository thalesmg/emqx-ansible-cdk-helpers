...

{
  ...
  time ./emqtt_bench sub -c {{ emqtt_bench_number_of_connections }} -i {{ emqtt_bench_interval }} -x {{ emqtt_bench_session_expiry_interval }} -t 'bench/%c/#' -h $TARGET --ifaddr $ipaddrs 2>&1
